function stateFIPSToJap(value) {
  const fipsMap = new Map([[1, "アラバマ州"], [2, "アラスカ州"], [4, "アリゾナ州"], [5, "アーカンソー州"], [6, "カリフォルニア州"], [8, "コロラド州"], [9, "コネチケット州"], [10, "デラウェア州"], [11, "ワシントンDC"], [12, "フロリダ州"], [13, "ジョージア州"], [15, "ハワイ州"], [16, "アイダホ州"], [17, "イリノイ州"], [18, "インディアナ州"], [19, "アイオワ州"], [20, "カンザス州"], [21, "ケンタッキー州"], [22, "ルイジアナ州"], [23, "メイン州"], [24, "メリーランド州"], [25, "マサチューセッツ州"], [26, "ミシガン州"], [27, "ミネソタ州"], [28, "ミシシッピ州"], [29, "ミズーリ州"], [30, "モンタナ州"], [31, "ネブラスカ州"], [32, "ネバダ州"], [33, "ニューハンプシャー州"], [34, "ニュージャージー州"], [35, "ニューメキシコ州"], [36, "ニューヨーク州"], [37, "ノースキャロライナ州"], [38, "ノースダコタ州"], [39, "オハイオ州"], [40, "オクラホマ州"], [41, "オレゴン州"], [42, "ペンシルベニア州"], [44, "ロードアイランド州"], [45, "サウスキャロライナ州"], [46, "サウスダコタ州"], [47, "テネシー州"], [48, "テキサス州"], [49, "ユタ州"], [50, "バーモント州"], [51, "バージニア州"], [53, "ワシントン州"], [54, "ウェストバージニア州"], [55, "ウィスコンシン州"], [56, "ワイオミング州"], [60, "アメリカ領サモア"], [64, "ミクロネシア連邦"], [66, "グアム"], [69, "北マリアナ諸島"], [70, "パラオ"], [72, "プエルトリコ"], [78, "アメリカ領ヴァージン諸島"]]);
...
function schoolNameToUrl(name) {
  let res = name.toLowerCase().replace(/[^a-z0-9 -&\(\)]+/g, "").split(" ").join("-");
  return res;
}
...
function calcStudentDemoOther(demoArr) {
  const accum = demoArr.reduce((prev, cur) => Number(parseFloat(cur).toFixed(3)) + Number(parseFloat(prev).toFixed(3)), 0);
